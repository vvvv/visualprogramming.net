<script setup>
    ...
    onMounted(()=>
    {
        ...
        keycloak = new KC(window.location.href, onReady)
    })
    ...
    <div class="card">
        <div class="card-header">
            <div class="row mx-1">
                ...
                <button class="btn btn-sm btn-secondary-outline" @click="logout" v-if="ready">Logout</button>
            </div>
        </div>    
